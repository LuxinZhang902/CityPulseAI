...
class SnowLeopardClient:
    ...
    def _parse_playground_result(self, result, original_question: str) -> Dict[str, Any]:
        """Parse Playground result to extract SQL and explanation."""
        try:
            # Extract data from RetrieveResponse
            if hasattr(result, 'data') and result.data:
                data_item = result.data[0]
                sql = data_item.query
                explanation = data_item.querySummary.get('non_technical_explanation', f"Generated by SnowLeopard Playground for: {original_question}")
